...
class Parser(object):
    def __init__(self):
        ...
        parser.add_argument("--max_episodes", default=50000, help="maximum number of training episodes", type=int)
    ...
    def Env_n_Agent_args(self, parser):
        ...
        parser.add_argument("--env_name", default='Maze', help="Environment to run the code")
    ...
    def Main_AC_args(self, parser):
        ...
        parser.add_argument("--critic_lr", default=1e-2, help="Learning rate of state features", type=float)
        parser.add_argument("--entropy_lambda", default=1e-4, help="Learning rate of state features", type=float)
